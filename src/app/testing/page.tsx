    ...
    return (
      <div className="rounded-xl bg-amber-500/10 border border-amber-500/30 p-6 text-amber-800">
        ...
        <p className="text-sm opacity-90 mb-2">
          From the <code className="bg-black/10 px-2 py-1 rounded">distillery</code> directory, run:
        </p>
      ...
      <main className="container mx-auto px-4 py-10 sm:py-16">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-text-light mb-10">
            How we ensure quality and reliability across the Small Distillery storefront codebase.
          </p>
