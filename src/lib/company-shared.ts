...
export const FALLBACK_COMPANY: Company = {
  ...
  tagline: 'Whiskeys, brandies & small-batch spirits',
  description: 'Shop limited releases, tasting flights, and cellar-worthy bottles from our distillery — with honest notes on every label.',
  logoUrl: null,
  heroImageUrl: null,
  ogImageUrl: null,
  brandColor: null,
